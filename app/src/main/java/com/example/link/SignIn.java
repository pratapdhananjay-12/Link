    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.signInBtnSignIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(binding.signInEtEmail.getText().toString().isEmpty()){
                    binding.signInEtEmail.setError("Enter your email");
                    return;
                }
                if(binding.signInEtPassword.getText().toString().isEmpty()){
                    binding.signInEtPassword.setError("Enter your password");
                    return;
                }
                progressDialog.show();
        ...
        binding.signInBtnGoogle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                signIn();
            }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            try {
                ...
                Log.d("Link", "firebaseAuthWithGoogle:" + account.getId());
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Log.d("Link", "signInWithCredential:success");
                            ...
                            Log.w("Link", "signInWithCredential:failure", task.getException());
                            //updateUI(null);
                        }
                    }
                });
